...
//               className=" aspect-square bg-[rgba(0,0,0,0.5)] backdrop-blur-lg rounded-2xl p-4"
//             >
//               <Image
//                 src={close}
//                 alt="Close"
...
//               />
//             </button>
//             <div className=" aspect-square bg-[rgba(0,0,0,0.5)] backdrop-blur-lg rounded-2xl p-4">
//               <Image
//                 src={fullScreenImage.featured ? addedFeature : addFeature}
//                 alt={
//                   fullScreenImage.featured ? "Remove Feature" : "Add Feature"
//                 }
//                 className="w-6 h-6 pointer-events-none"
//               />
//             </div>
...
const AdminDashboard = () => {
  ...
  return (
    <div className="relative flex items-start justify-center w-screen overflow-hidden h-dvh">
      {fullScreenImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center w-screen h-screen bg-black bg-opacity-75">
          <div className="absolute flex flex-col gap-4 top-4 right-4">
            ...
            <button
              onClick={() => toggleFeature(fullScreenImage.id)}
              className=" aspect-square bg-[rgba(0,0,0,0.5)] transition-all duration-200 hover:bg-[rgba(255,255,255,0.2)] backdrop-blur-lg rounded-2xl p-4"
            >
              <Image
                src={fullScreenImage.featured ? addedFeature : addFeature}
            ...
            <button
              onClick={() => handleDownload(fullScreenImage.aiUrl)}
              className=" aspect-square bg-[rgba(0,0,0,0.5)] transition-all duration-200 hover:bg-[rgba(255,255,255,0.2)] backdrop-blur-lg rounded-2xl p-4"
            >
              <Image
                src={downloadIcon}
            ...
            <button
              onClick={() => deleteImage(fullScreenImage.id)}
              className=" aspect-square bg-[rgba(0,0,0,0.5)] transition-all duration-200 hover:bg-[rgba(255,255,255,0.2)] backdrop-blur-lg rounded-2xl p-4"
            >
              <Image
                src={Delete}
      ...
      <div
        className={`absolute z-50 flex flex-col top-4 left-4 transition-all duration-500 bg-[rgba(255,255,255,0.5)] backdrop-blur-lg aspect-square p-2 sm:p-4 items-center justify-center rounded-xl sm:rounded-2xl lg:hidden ${
          menuActive ? "gap-0" : "gap-[6px]"
        }`}
        onClick={toggleMenu}
      >
